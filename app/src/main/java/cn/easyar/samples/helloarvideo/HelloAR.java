...
public class HelloAR
{
    ...
    public void initGL()
    {
        ...
        for (int k = 0; k < trackers.get(0).targets().size(); k += 1) {
                ...
                if (status == TargetStatus.Tracked) {
                    ...
                    if (tracked_target == 0) {
                        if (video == null && video_renderers.size() > 0) {
                            ...
                            int i = Integer.valueOf(uid);

                            if (video_renderers.get(i).texId() != 0) {
                                video = new ARVideo();
                                video.openVideoFile(target_name + ".mp4", video_renderers.get(i).texId());
                            ...
                            if (target_name.equals("argame") && video_renderers.get(0).texId() != 0) {
                                ...
                                video.openLocalVideoFile("file:///storage/emulated/0/Download/V80319-230507.mp4", video_renderers.get(0).texId());
                            ...
                            } else if (target_name.equals("liteng") && video_renderers.get(3).texId() != 0) {
                                video = new ARVideo();
